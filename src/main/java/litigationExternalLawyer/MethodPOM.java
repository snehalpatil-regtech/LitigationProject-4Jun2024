...
//		       //	elementsList = performerPOM.chooseAct(driver);
		 ...
		 public  static void clickCaseInternalUser(WebDriver driver) throws InterruptedException 
			...
			public static void TaskActivity1(WebDriver driver, ExtentTest test, XSSFWorkbook workbook,String login) throws InterruptedException, IOException
			{
			    ...
			    Thread.sleep(8000);
			    performerPOM.clickHearingDate(driver).sendKeys("25-03-2025");
			    Thread.sleep(8000);
...
//				
				performerPOM.clickCaseHearingDate(driver).sendKeys("12-03-2025");	//Writing 'HearingDate'
			...
			public static void CaseOrder(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException
			{
				...
				// driver.switchTo().parentFrame();
				 ...
				 Thread.sleep(8000);
				 performerPOM. clickCaseOrderDate(driver).sendKeys("13-10-2024");
				 Thread.sleep(8000);
...
//				performerPOM.selectFromDate(driver).click();
			...
			static void NewReminder(WebDriver driver, ExtentTest test, String type) throws InterruptedException
			{
				...
				Thread.sleep(3000);
				performerPOM.clickReminderText(driver).sendKeys("Reminder as on  test 16");
				
				Thread.sleep(3000);
				performerPOM.clickDescription(driver).sendKeys("Reminder as on  test 16");
				
				Thread.sleep(3000);
				performerPOM.clickRemark2(driver).sendKeys("Reminder as on test 16");
...
//				}
				...
				Thread.sleep(3000);
				performerPOM.clickReminderText(driver).sendKeys("Reminder as on  test 1");
