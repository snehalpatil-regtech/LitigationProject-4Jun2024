...
//				action.moveToElement(performerPOM.clickSearchExternalUser(driver)).sendKeys(externalUser, Keys.ENTER).perform();
			...
			OverduePOM.clickSaveButton(driver).click();				//Clicking on 'Save' button.
				...
				Thread.sleep(8000);
				performerPOM.clickTaskTitle(driver).sendKeys(" Task 28july");	//Writing 'Task Title'
...
//	    }
	...
	public static void CloseNoticeCase(WebDriver driver, ExtentTest test, XSSFWorkbook workbook, String type,String login) throws InterruptedException, IOException
	{
		...
		else if(type.equals("Task"))
		{
			...
			else if(login.equalsIgnoreCase("performer regtrack"))	
			{
				Thread.sleep(4000);
				performerPOM.clickFilter(driver).click();
				Thread.sleep(4000);
				performerPOM.clickSearchFilterworkspace1(driver).sendKeys("performer regtrack");
				Thread.sleep(4000);
...
//			
		...
		{			
			...
			if(msg.equalsIgnoreCase("1 Case Hearing(s) Details Uploaded Successfully"))
			{
				test.log(LogStatus.PASS, "Message displayed = "+msg);
...
//						performerPOM.selectDocument(driver).click();	
					...
					//	driver.switchTo().alert().accept();
						...
						/*	Thread.sleep(2000);
							...
							Thread.sleep(2000);
							performerPOM.ClickEditFolder(driver).click();	
							
							Thread.sleep(8000);
							OverduePOM.writeFolderName(driver).clear();			
							Thread.sleep(8000);
							OverduePOM.writeFolderName(driver).sendKeys("Automation Test");			//Writing Folder name.
							
							Thread.sleep(8000);
							OverduePOM.clickCreate(driver).click();	
	 		 ...
	 		 public static void ClosedNoticeDoc(WebDriver driver, ExtentTest test) throws InterruptedException, IOException
		 		{
					...
					performerPOM.selectTypeNotice(driver).click();					//Selecting 'Case' option.
				       ...
				       performerPOM.clickFilter2(driver).click();
				        ...
				        Thread.sleep(8000);
				       performerPOM.clickSearchFilterworkspace(driver).sendKeys("87234");
